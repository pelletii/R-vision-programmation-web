...
en vous aidant du script _section.php_, vous devrez écrire le script `lieu.php` qui va afficher le nom des lieux et un bouton d'action, `voir détail`. Quelques questions à se poser avant de débuter la modification de l'application web :
