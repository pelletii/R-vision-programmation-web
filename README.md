...
2. **Ouvrir le service php dans un navigateur pour afficher la page d'accueil du site** :
   - se positionner sur l'onglet *PORTS* de la console de débogage et cliquer sur l'icone d'internet
   ![alt text](image.png)

3. **Accèder à la BDD** :
   - se positionner sur l'onglet *PORTS* de la console de débogage et cliquer sur l'icone pour phpMyAdmin
   ![alt text](image-1.png)
         

### Initialiser la base de données BdAssoCult:
